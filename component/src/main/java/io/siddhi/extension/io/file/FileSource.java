        ...
        parameters = {
                ...
                @Parameter(
                        ...
                        description = "This parameter used to specify a particular text file (eg: CSV) contains a " +
                                "header line or not. This can either have value true or false. If it's set to `true` then " +
                                "it indicates a file contains a header line, and it will not process",
