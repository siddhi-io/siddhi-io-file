...
public class FileProcessor_test {
    ...
    public FileProcessor_test(SiddhiAppContext siddhiAppContext, SourceEventListener sourceEventListener, FileObject fileObject, boolean isFileTailingEnabled){
